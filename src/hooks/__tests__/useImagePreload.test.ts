...
describe('useImagePreload Hook', () => {
  ...
  const mockVideos: EmbyItem[] = [
    { Id: 'video1', Name: 'Video 1', Type: 'Video', MediaType: 'Video', ImageTags: { Primary: 'primary1' } },
    { Id: 'video2', Name: 'Video 2', Type: 'Video', MediaType: 'Video', ImageTags: { Primary: 'primary2' } },
    { Id: 'video3', Name: 'Video 3', Type: 'Video', MediaType: 'Video', ImageTags: { Primary: 'primary3' } }
  ];
