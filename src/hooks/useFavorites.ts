...
export function useFavorites() {
  ...
  const addToFavorites = useCallback((itemId: string, collectionId?: string) => {
  ...
  const removeFromFavorites = useCallback((itemId: string, collectionId?: string) => {
    if (collectionId) {
      setFavoritesState(prev => ({
        ...prev,
        collections: prev.collections.map(c => {
  ...
  const isFavorite = useCallback((itemId: string, collectionId?: string) => {
    if (collectionId) {
