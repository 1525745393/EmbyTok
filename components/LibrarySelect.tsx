          ...
          {mode === 'list' ? (
            ...
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-white font-bold text-xl">
                {mode === 'settings'
                  ? t.librarySelect.settings
                  : mode === 'sponsor'
                    ? t.librarySelect.sponsorPage
                    : t.librarySelect.about}
              </h2>
            </div>
          )}
              ...
              <div className="space-y-3">
                ...
                <div className="bg-zinc-800 rounded-xl p-1 flex">
                  {['vertical', 'horizontal', 'both'].map((m) => (
                    ...
                    >
                      {m === 'vertical'
                        ? t.librarySelect.vertical
                        : m === 'horizontal'
                          ? t.librarySelect.horizontal
                          : t.librarySelect.both}
                    </button>
                  ))}
                </div>
              </div>
          ...
          {mode === 'about' && (
            <div className="space-y-6 p-4">
              <div className="bg-gradient-to-br from-indigo-600/10 to-transparent p-6 rounded-2xl border border-white/5">
                ...
                <div className="text-sm font-bold text-indigo-400 mb-4">
                  {t.librarySelect.version(version)}
                </div>
                <p className="text-xs text-white/70 leading-relaxed mb-6">
                  {t.librarySelect.aboutDesc}
                </p>
                <div className="flex gap-2 flex-wrap mb-6">
                  <div className="bg-white/5 px-3 py-1 rounded-full text-[10px] font-black border border-white/5 uppercase tracking-widest">
                    React 18
                  </div>
                  <div className="bg-white/5 px-3 py-1 rounded-full text-[10px] font-black border border-white/5 uppercase tracking-widest">
                    TypeScript
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-indigo-400 text-sm font-bold hover:text-indigo-300 transition-colors mt-4"
                >
                  <ExternalLink className="w-4 h-4" />
          ...
          {mode === 'sponsor' && (
            <div className="space-y-6 p-4">
              <div className="bg-gradient-to-br from-indigo-600/10 to-transparent p-6 rounded-2xl border border-white/5">
                ...
                <p className="text-xs text-indigo-400 leading-relaxed mb-6">
                  {t.librarySelect.sponsorThanks}
                </p>
              </div>
        ...
        {mode === 'list' && (
          <div className="p-3 border-t border-zinc-800 bg-zinc-900 flex gap-2">
            ...
            >
              ...
              <span className="font-bold text-sm">{t.librarySelect.settings}</span>
            </button>
            <button
              onClick={() => setMode('about')}
