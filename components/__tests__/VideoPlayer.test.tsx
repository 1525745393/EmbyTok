...
describe('VideoPlayer Component', () => {
  ...
  it('does not display play button when video is playing', () => {
    ...
    const hasPlayOverlay = Array.from(overlays).some(el => 
      el.textContent?.includes('Play') || el.querySelector('[class*="Play"]')
    );
  ...
  it('does not display seek indicator when seekOffset is null', () => {
    ...
    const hasSeekIndicator = document.body.textContent?.includes('+') || 
