...
describe('device utils', () => {
  describe('isMobile', () => {
    ...
    it('should return true for Android userAgent', () => {
      Object.defineProperty(window.navigator, 'userAgent', {
        value: 'Mozilla/5.0 (Linux; Android 10; SM-G970F) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36',
        configurable: true
      });
  ...
  describe('isLandscape', () => {
    ...
    afterEach(() => {
      vi.restoreAllMocks();
      if (originalWindow) {
        Object.defineProperty(window, 'innerWidth', { value: originalWindow.innerWidth, configurable: true });
        Object.defineProperty(window, 'innerHeight', { value: originalWindow.innerHeight, configurable: true });
      }
    });
